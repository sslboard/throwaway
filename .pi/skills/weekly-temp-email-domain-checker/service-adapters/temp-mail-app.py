"""Deterministic browser-harness adapter for temp-mail.app."""
import json, os, re

SERVICE = "temp-mail.app"
URL = os.environ.get("SERVICE_URL", "https://temp-mail.app/")
...
try:
    ...
    for _ in range(8):
        ...
        generated = [e for e in data.get("emails", []) if not e.endswith("@temp-mail.app")]
        if generated:
    ...
    if result["emails"]:
        ...
        result["notes"].append("No generated email found on temp-mail.app.")
