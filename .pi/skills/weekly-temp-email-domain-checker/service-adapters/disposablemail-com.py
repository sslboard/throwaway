"""Deterministic browser-harness adapter for disposablemail.com."""

import json
import os

SERVICE = "disposablemail.com"
URL = os.environ.get("SERVICE_URL", "https://www.disposablemail.com/")
...
(() => {
  ...
  for (const el of Array.from(document.querySelectorAll('input.pravaCastInput'))) add('domain-suffix-input', el.value || el.getAttribute('value') || '', 'input.pravaCastInput');
