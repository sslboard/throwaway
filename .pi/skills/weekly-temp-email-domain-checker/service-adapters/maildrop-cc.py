"""Deterministic browser-harness adapter for maildrop.cc."""
import json
import os
SERVICE = "maildrop.cc"
URL = os.environ.get("SERVICE_URL", "https://maildrop.cc/")
EXTRACT_QUERY = r"""
(() => {
  ...
  add('suggested-email-body', document.body ? document.body.innerText : '', 'document.body.innerText');
