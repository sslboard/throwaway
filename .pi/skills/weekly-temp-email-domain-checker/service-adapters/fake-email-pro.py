"""Deterministic browser-harness adapter for fake-email.pro."""
import json
import os
SERVICE = "fake-email.pro"
URL = os.environ.get("SERVICE_URL", "https://fake-email.pro/10-minute-mail")
EXTRACT_QUERY = r"""
(() => {
  ...
  for (const btn of Array.from(document.querySelectorAll('button'))) {
    add('generated-email-button', btn.innerText || btn.textContent || '', 'button');
  }
