"""Deterministic browser-harness adapter for tempail.com."""

import json
import os

SERVICE = "tempail.com"
URL = os.environ.get("SERVICE_URL", "https://tempail.com/")
...
(() => {
  ...
  // Tempail renders the generated address in readonly input#eposta_adres.
  const input = document.querySelector('input#eposta_adres');
  if (input) add('generated-email-input', input.value || input.getAttribute('value') || '', '#eposta_adres');
