"""Deterministic browser-harness adapter for 10minemail.com."""
import json
import os
SERVICE = "10minemail.com"
URL = os.environ.get("SERVICE_URL", "https://10minemail.com/en/")
EXTRACT_QUERY = r"""
(() => {
  ...
  if (input) add('generated-email-input', input.value || input.getAttribute('value') || '', '#mail');
