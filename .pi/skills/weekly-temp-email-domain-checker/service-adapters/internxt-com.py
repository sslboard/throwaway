"""Deterministic browser-harness adapter for internxt.com."""

import json
import os

SERVICE = "internxt.com"
URL = os.environ.get("SERVICE_URL", "https://internxt.com/temporary-email")
...
(() => {
  ...
  // Internxt renders the generated temporary address as button text in the temporary-email widget.
  for (const el of Array.from(document.querySelectorAll('button'))) {
    add('generated-email-button', el.innerText || el.textContent || '', el.id ? `#${el.id}` : 'button');
  }
